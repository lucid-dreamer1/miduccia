...
<body style="margin:0;padding:0;background-color:#f7f6f0;font-family:'Inter',system-ui,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="text-align:center;padding:24px 0;border-bottom:2px solid #ece9d8;">
      <h1 style="font-family:Georgia,serif;font-size:26px;color:#3a3222;margin:0;letter-spacing:0.5px;">Osteria da Miduccia</h1>
    ...
    <div style="border-top:2px solid #ece9d8;padding:20px 0;text-align:center;">
      <p style="color:#ae9f62;font-size:12px;margin:0;">Osteria da Miduccia · Via Example 123, Caserta</p>
      <p style="color:#ae9f62;font-size:12px;margin:4px 0 0;">Tel. +39 0823 456 789</p>
    </div>
  </div>
</body>
</html>`;
...
function bookingDetailsHtml(data: BookingEmailData): string {
  return `
    <div style="background:#ffffff;border:1px solid #ece9d8;border-radius:14px;padding:24px;margin:20px 0;">
      <table style="width:100%;border-collapse:collapse;font-size:14px;color:#3a3222;">
        ...
        <tr><td style="padding:10px 0;border-bottom:1px solid #f7f6f0;color:#96844a;font-weight:600;">Telefono</td><td style="padding:10px 0;border-bottom:1px solid #f7f6f0;"><a href="tel:${data.phone}" style="color:#d46a2a;text-decoration:none;font-weight:600;">${data.phone}</a></td></tr>
