  ...
  return (
    <section id="prenota" className="py-20 sm:py-28 bg-olive-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {state.success && (
          <div className="mb-8 bg-green-500/10 border border-green-500/30 rounded-2xl p-6 text-center animate-fade-in">
            <p className="text-green-400 font-semibold text-lg tracking-tight">Richiesta inviata con successo</p>
            <p className="text-green-300/80 text-sm mt-2 leading-relaxed max-w-lg mx-auto">{state.message}</p>
          </div>
        )}
        {state.error && (
